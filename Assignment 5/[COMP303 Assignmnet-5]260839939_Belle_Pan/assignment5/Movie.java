 ...
 */
public class Movie extends Media implements Sequenceable<Movie> {
...
//		aStudio = pStudio;
	...
	/**
	 * Updates the WatchList that the Movie is associated with
	 * 
...
//	
	/**
	 * Returns the watchlist the Movie is associated with, i.e. the watchlist that the movie has been added to
	 * 
	 * @pre aWatchList.isPresent()
	 * 
	 * @return the watchlist associated with the movie
	 */
